...
final public class PessoaJuridica  extends Pessoa {
    ...
    public String cumprimentar() {
        return "Olá, somos da empresa " + this.nomeFantasia + ", de razão social " + this.razaoSocial + " cujo CNPJ é " + this.cnpj + ", Nosso e-mail é " + this.email + ", nosso telefone de contato é " + this.telefone + " e estamos localizados no endereço " + this.endereco + ".";
    }
}
